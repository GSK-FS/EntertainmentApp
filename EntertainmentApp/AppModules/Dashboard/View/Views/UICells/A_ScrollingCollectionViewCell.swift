//
//  A_ScrollingCollectionViewCell.swift
//  EntertainmentApp
//
...
class A_ScrollingCollectionViewCell: BaseCollectionViewCell {
...
extension A_ScrollingCollectionViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: A_StyleCollectionViewCell.identifier, for: indexPath) as? A_StyleCollectionViewCell {
