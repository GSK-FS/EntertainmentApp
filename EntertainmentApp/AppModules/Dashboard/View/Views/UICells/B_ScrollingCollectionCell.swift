//
//  B_ScrollingCollectionCell.swift
//  EntertainmentApp
//
...
import UIKit
class B_ScrollingCollectionCell: BaseCollectionViewCell {
    ...
    override func viewsConfiguration() {
        ...
        horizontalCollectionView.register(B_StyleCollectionViewCell.self, forCellWithReuseIdentifier: B_StyleCollectionViewCell.identifier)
...
extension B_ScrollingCollectionCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: B_StyleCollectionViewCell.identifier, for: indexPath) as? B_StyleCollectionViewCell {
            cell.imageView.image = UIImage(named: movieInfo[indexPath.item].image!)
            cell.labelTitle.text = movieInfo[indexPath.item].name!
            let viewsNumber = movieInfo[indexPath.item].viewsNumber!
            cell.labelDetailInfo.text = "\(viewsNumber) Views"
            
            cell.imageView.contentMode = .scaleAspectFill
            cell.imageView.layer.cornerRadius = (150/2).wRatio
    ...
    //        let cellSize = sizeOfCell//CGSize(width: 138.wRatio, height: 138.wRatio)
    //        return cellSize
    //    }
